      ...
      <div className="space-y-5">
        ...
        {step === 0 && (
          <div className="space-y-4">
            <div className="grid aspect-[3/4] w-full place-items-center rounded-2xl bg-foreground/90 text-background">
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <div className="flex gap-2">
                {hasMedia && <div className="h-16 w-16 rounded-lg bg-foreground/80" />}
                <button
        ...
        {step === 2 && (
          <div className="space-y-5">
            <div className="flex gap-2">
              <div className="h-28 flex-1 rounded-xl bg-foreground/80" />
